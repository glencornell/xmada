...
package Xm_Row_Column is
   ...
   subtype Xm_Row_Column_Widget is Xm_Manager.Xm_Manager_Widget;
   subtype Xm_Row_Column_Class is Xm_Manager.Xm_Manager_Class;

   Xm_Row_Column_Widget_Class : constant Xm_Row_Column_Class;
...
private
   ...
   pragma Import (C, Xm_Row_Column_Widget_Class, "xmRowColumnWidgetClass");
