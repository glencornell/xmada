...
package Designer.Operations is
   ...
   --!    <Purpose> Создает новое приложение в существующем проекте.
   --!    <Exceptions>
   ---------------------------------------------------------------------------
   procedure New_Application (Project : in Model.Node_Id);

   ---------------------------------------------------------------------------
   --! <Subprogram>
   --!    <Unit> New_Component
   --!    <Purpose> Создает новый компонент в уже существующем приложении.
   --!    <Exceptions>
   ---------------------------------------------------------------------------
   procedure New_Component (Application : in Model.Node_Id);
