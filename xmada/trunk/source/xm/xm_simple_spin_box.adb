...
package body Xm_Simple_Spin_Box is
   ...
   is
      Return_Value : Widget;
   begin
      Return_Value := Xm_Create_Simple_Spin_Box (Parent, Name, Arg_List);
      Xt_Manage_Child (Return_Value);
      return Return_Value;
   end Xm_Create_Managed_Simple_Spin_Box;


   ---------------------------------------------------------------------------
   --! <Subprogram>
   --!    <Unit> Xm_Create_Simple_Spin_Box
   ...
   function Xm_Create_Simple_Spin_Box
    (Parent   : in Widget;
     ...
     Arg_List : in Xt_Arg_List := Null_Xt_Arg_List)
       return Xm_Simple_Spin_Box_Widget
   is
      function XmCreateSimpleSpinBox (Parent    : in Widget;
                                      Name      : in char_array;
