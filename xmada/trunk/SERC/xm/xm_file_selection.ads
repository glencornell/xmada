...
package Xm_File_Selection is
    Copyright_Notice : constant String :=
       "(C) Copyright 2005, Integrated Computer Solutions, Inc.  " &
	  "All Rights Reserved.";

    subtype File_Selection_Dialog_Class is Xm_Selection_Box.Selection_Box_Class;
    subtype File_Selection_Dialog_Widget is Xm_Selection_Box.Selection_Box_Widget;


    function Xm_File_Selection_Widget_Class
	return Xm_File_Selection_Box.File_Selection_Box_Class
	renames Xm_File_Selection_Box.Xm_File_Selection_Box_Widget_Class;

    function Xm_File_Selection_Dialog_Widget_Class
	return Xm_File_Selection_Box.File_Selection_Box_Class
	renames Xm_File_Selection_Box.Xm_File_Selection_Box_Widget_Class;
    ...
    function Xm_Create_File_Selection_Dialog
		...
		return Xm.Xt_Widget
		renames Xm_File_Selection_Box.Xm_Create_File_Selection_Dialog;

end Xm_File_Selection;
