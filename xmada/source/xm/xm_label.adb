...
package body Xm_Label is
   ...
   is
      function XmCreateLabel (Parent    : in Widget;
                              Name      : in char_array;
                              Arg_List  : in Xt_Arg_List;
                              Arg_Count : in Cardinal)
        return Widget;
      pragma Import (C, XmCreateLabel, "XmCreateLabel");
   begin
      return XmCreateLabel (Parent, To_C (Name), Arg_List, Arg_List'Length);
   end Xm_Create_Label;
   ...
   is
      Return_Value : Widget;
   begin
      Return_Value := Xm_Create_Label (Parent, Name, Arg_List);
      Xt_Manage_Child (Return_Value);
      return Return_Value;
   end Xm_Create_Managed_Label;
